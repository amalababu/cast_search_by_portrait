...
class TestImage(Dataset):
    ...
    def __init__(self, test_root, test_file, resize=None, crop_size=None, flip=False, imagenet_norm=True):
        ...
        # Adding the cast features as well in the re-identification phase to obtain the ranking list based on body features alone
            num = len(self.files)
            ...
            # Pre appending the cast features before candidate features
